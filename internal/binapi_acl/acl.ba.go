...
// Package acl 提供 VPP ACL 插件的 Go 语言绑定（API 消息和 RPC 方法）。
//
// 本模块由 GoVPP binapi-generator 自动生成，对应 VPP API 版本 23.10-rc0~170-g6f1548434。
//
// 原始来源:
//   - 仓库: github.com/networkservicemesh/govpp
//   - 版本哈希: v0.0.0-20240328101142-8a444680fbba
//   - 相对路径: binapi/acl/
//   - 本地化日期: 2025-11-13
//
// 注意事项:
//   1. 本文件由代码生成器创建，请勿手动编辑
//   2. 依赖本地化的 acl_types 模块（../binapi_acl_types）
//   3. 升级 VPP 版本时需要同步更新本模块
//
// Contents:
// - 42 messages
package acl
